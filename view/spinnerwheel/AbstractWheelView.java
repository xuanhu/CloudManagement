...
import com.tg.cloudmanagement.inter.MyObjectAnimtor;
...
public abstract class AbstractWheelView extends AbstractWheel {
     ...
     */
    protected MyObjectAnimtor mDimSelectorWheelAnimator;

    /**
     * {@link com.nineoldandroids.animation.Animator} for dimming the selector spinnerwheel.
     */
    protected MyObjectAnimtor mDimSeparatorsAnimator;
    ...
    protected void initData(Context context) {
        ...
        // creating animators
        mDimSelectorWheelAnimator = MyObjectAnimtor.ofFloat(this, PROPERTY_SELECTOR_PAINT_COEFF, 1, 0);
        mDimSeparatorsAnimator = MyObjectAnimtor.ofInt(this, PROPERTY_SEPARATORS_PAINT_ALPHA,
