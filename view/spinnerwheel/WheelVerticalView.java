...
public class WheelVerticalView extends AbstractWheelView {
    ...
    public void setSelectorPaintCoeff(float coeff) {
        ...
        if (mVisibleItems == 2) {
            ...
            int[] colors =      {0, 0x4f000000, 0x4f000000, 0x4f000000, 0xff000000, 0xff000000, 0x4f000000, 0x4f000000, 0x4f000000, 0};
    ...
    protected int getItemDimension() {
        if (mItemHeight != 0) {
        	...
        	View v = inflate(mContext, R.layout.address_province_item, null);
        	TextView tv = (TextView)v.findViewById(R.id.province_tv);
        	tv.measure(0, 0);
        	mItemHeight = tv.getMeasuredHeight();
        	return mItemHeight;
        }
    ...
    protected void drawItems(Canvas canvas) {
        ...
        int h = getMeasuredHeight();
        int ih = getItemDimension();
        if(mSpinBitmap == null || mSeparatorsBitmap == null){
        	recreateAssets(w,h);
        }
